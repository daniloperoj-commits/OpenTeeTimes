...
/* Botones secundarios usados bajo tarjetas de resultados */
            ...
            for i in range(0, len(resultados), 4):
                ...
                for pos, (col, r) in enumerate(zip(columnas, resultados[i:i+4])):
                    ...
                    with col:
                        ...
                        if st.button("Info reservas", key=f"info_reservas_{idx_resultado}_{r.get('campo_id', 'sin_id')}_{r.get('hora', '')}", use_container_width=True):
            ...
            for i in range(0, len(campos_no_consultables), 4):
                ...
                for pos, (col, campo_nc) in enumerate(zip(columnas, campos_no_consultables[i:i+4])):
                    ...
                    with col:
                        ...
                        if st.button("Info del club", key=f"info_club_{idx_campo}_{campo_nc.get('campo_id', 'sin_id')}", use_container_width=True):
